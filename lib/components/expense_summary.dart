...
class ExpenseSummary extends StatelessWidget {
  ...
  double calculateMax(ExpenseData value, String sunday, String monday, String tuesday,
  ...
  String calculateWeekTotal(ExpenseData value, String sunday, String monday, String tuesday,
      String wednesday, String thursday, String friday, String saturday) {
    List<double> values = [
      value.calculateDailyExpenseSummary()[sunday] ?? 0,
      value.calculateDailyExpenseSummary()[monday] ?? 0,
    ...
    double total = values.reduce((sum, element) => sum + element);
